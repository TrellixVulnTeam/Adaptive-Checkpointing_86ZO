...
cp "$FLINKROOT"/flink-examples/flink-examples-streaming/target/Query1-jar-with-dependencies.jar "$bin"/"$TARGET_DIR"/"$QUERY3".jar
cp "$FLINKROOT"/flink-examples/flink-examples-streaming/target/Query1-jar-with-dependencies.jar "$bin"/"$TARGET_DIR"/"$QUERY5".jar
cp "$FLINKROOT"/flink-examples/flink-examples-streaming/target/Query1-jar-with-dependencies.jar "$bin"/"$TARGET_DIR"/"$QUERY8".jar
...
cp "$FLINKROOT"/flink-examples/flink-examples-streaming/target/KafkaSourceBid-jar-with-dependencies.jar "$bin"/"$TARGET_DIR"/"$PERSON_SOURCE".jar
